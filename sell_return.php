...
<script> alert('Data has been deleted'); window.location.href='sell_return.php'; </script>
<?php   }
   }
 ...
 <div class="row">
       <div class="col">
         <div class="bg-light card card-body" style=" background: #b4c6d8 !important">
          <h1 style="text-align: center;">Sell return</h1>
         </div>
       </div>
     </div>
<div class="row">
   <div class="col">
            ...
            <form action="" class="form">
              ...
              <div class="form-group">
                <button type="button" class="btn btn-success btn-lg" onclick="savereturninfo()" >Save Order Return Information</button>
              </div>
         ...
         <table class="table table-condensed table-bordered table-hover table-striped" id="myTable" >
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td><a class="btn btn-danger" href="sell_return.php?del-id=<?=$val['memono']?>" onclick="return confirm('Are you sure?')">Delete</a></td>
               </tr>
               <?php   }
                  ?>
            </tbody>
